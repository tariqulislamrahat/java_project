...
public class ChangePasswordSeller extends JFrame {
    ...
    private static final String SELLER_DATA_FILE = "data/seller_data.txt";

    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ChangePasswordSeller().showChangePasswordPage());
    }
    ...
    public void showChangePasswordPage() {
        ...
        JLabel headerLabel = new JLabel("Change Seller Password");
    ...
    private void changePassword(JPasswordField currentPasswordField, JPasswordField newPasswordField, JPasswordField confirmPasswordField) {
        ...
        String storedPassword = readSellerPassword();
    ...
    private String readSellerPassword() {
        try (Scanner scanner = new Scanner(new FileReader(SELLER_DATA_FILE))) {
            ...
            System.err.println("Error reading seller data file: " + e.getMessage());
        }
        return null;
    }

    private void updatePassword(String newPassword) {
        try (BufferedReader br = new BufferedReader(new FileReader(SELLER_DATA_FILE))) {
            ...
            if (line != null) {
                ...
                if (parts.length > 1) {
                    ...
                    try (BufferedWriter bw = new BufferedWriter(new FileWriter(SELLER_DATA_FILE))) {
                        bw.write(updatedLine);
                    } catch (IOException e) {
                        System.err.println("Error writing to seller data file: " + e.getMessage());
                    }
                }
            }
        } catch (IOException e) {
