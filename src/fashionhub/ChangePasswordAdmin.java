...
public class ChangePasswordAdmin extends JFrame {
    ...
    private static final String ADMIN_DATA_FILE = "data/admin_data.txt";

    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ChangePasswordAdmin().showChangePasswordPage());
    }
    ...
    public void showChangePasswordPage() {
        ...
        JLabel headerLabel = new JLabel("Change Admin Password");
    ...
    private String readAdminPassword() {
        try (Scanner scanner = new Scanner(new FileReader(ADMIN_DATA_FILE))) {
    ...
    private void updatePassword(String newPassword) {
        try (BufferedReader br = new BufferedReader(new FileReader(ADMIN_DATA_FILE))) {
            ...
            if (line != null) {
                ...
                if (parts.length > 1) {
                    ...
                    try (BufferedWriter bw = new BufferedWriter(new FileWriter(ADMIN_DATA_FILE))) {
                        bw.write(updatedLine);
                    } catch (IOException e) {
                        System.err.println("Error writing to admin data file: " + e.getMessage());
                    }
                }
            }
        } catch (IOException e) {
